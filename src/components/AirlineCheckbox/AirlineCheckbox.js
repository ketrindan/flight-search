...
function AirlineCheckbox(props) {
  return (
    <div className={airlineCheckboxStyles.container}>
      <input type="checkbox" name="airline_filter" id={props.airline} value={props.airline} className={airlineCheckboxStyles.filter} 
        onChange={props.handleChoose} checked={props.chosenAirlines.includes(props.airline)}
      />
